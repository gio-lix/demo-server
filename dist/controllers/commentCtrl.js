...
const commentCtrl = {
    createComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const newComment = new commentModule_1.default({
                user: req.user._id,
                content,
                blog_id,
                blog_user_id
    ...
    getComments: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const data = yield commentModule_1.default.aggregate([
                {
                    $facet: {
                        totalData: [
                            // @ts-ignore
                            { $match: { blog_id: mongoose_1.default.Types.ObjectId(req.params.id),
    ...
    replyComments: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        if (!req.user)
            return res.status(400).json({ msg: "Invalid Authentication" });
        try {
            ...
            yield commentModule_1.default.findOneAndUpdate({ _id: comment_root }, {
    ...
    updateComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const { data } = req.body;
            const updateComment = yield commentModule_1.default.findOneAndUpdate({
                _id: req.params.id,
                user: req.user.id
    ...
    deleteComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const comment = yield commentModule_1.default.findOneAndDelete({
                _id: req.params.id,
                $or: [
                    { user: req.user._id },
            ...
            if (comment.comment_root) {
                yield commentModule_1.default.findOneAndUpdate({ _id: comment.comment_root }, {
                    $pull: { replyCM: comment._id }
                });
            }
            else {
                yield commentModule_1.default.deleteMany({ _id: { $in: comment.replyCM } });
            }
            index_1.io.to(`${comment.blog_id}`).emit("commentDelete", comment);
